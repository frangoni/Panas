    ...
    <>
      <Switch>
        ...
        <Route
          exact
          path="/checkin"
          component=/*{Checkin} */ {user && user.rol == "checkin" ? Checkin : notAuthorized}
        />
        <Route
          exact
          path="/admin"
          component={Dashboard} /*   {user && user.rol == 'admin' ? Dashboard : notAuthorized}*/
        />
        <Route
          exact
          path="/:station"
          component=/*{Station} */ {user && user.rol != ["checkin", "admin"] ? Station : notAuthorized}
        />
